...
const navItems = ['Hero','About','Nexus','Story','Contact']
                    ...
                    <div className="flex h-full items-center">
                        <div className="block">
                            {navItems.map((item,index)=>
                                <a  onClick={()=>scrollToSection(`#${item.toLowerCase()}`)} className={`nav-hover-btn ${item.toLowerCase() == 'hero' ? 'hidden md:inline' : ''}`} key={index}>{item}</a>
                            )}
                        </div>

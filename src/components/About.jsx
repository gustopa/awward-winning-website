...
function About() {
    ...
    return (
      <div id="about" className="min-h-screen w-screen overflow-y-hidden">
        <div className="relative mt-36 flex flex-col items-center gap-5 ">
            ...
            <div className="about-subtext" >
                <p className="">The Game of Games begins-your life, now an epic MMORPG</p>
                <p className="text-gray-500">Zentry unites every player from countless game and platforms</p>
            </div>     
        </div>
